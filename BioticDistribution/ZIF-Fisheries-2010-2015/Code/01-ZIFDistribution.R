...
# Select gear type of interest
# Gear type                   Number of records
# Casier                      104117
# Chalut de fond              46849
# Drague                      11794
# Filet maillant              24223
# Palangre                    8286
# Peche a la ligne            10155
# Plongee                     1987
# Senne bourse                2488
# Senne Danoise ou Ecossaise  3109
# Senne de rivage             414
# Trappe                      914
# Turlutte                    137
uid <- biotic$gear == 'Chalut de fond'
biotic <- biotic[uid, ]
...
# ------------------------
uid <- stringr::str_detect(colnames(biotic), 'sst')
biotic$sst <- rowMeans(biotic[, uid, drop = T], na.rm = T)
...
# Export
save(biotic, file = './BioticDistribution/ZIF-Fisheries-2010-2015/Data/dataHMSC.RData')
...
# save model
save(model, file = './BioticDistribution/ZIF-Fisheries-2010-2015/Data/modelHMSC.RData')
